...
import { Delivery } from 'app/delsos/shopper-profile/delivery.dto';
...
export class TrackModalService {
  ...
  sendCurrentPosition(currentPosition):Observable<Delivery> {
    return this.http.patch<Delivery>(`${this.apiServerUrl}/delivery/addTrackingData`,currentPosition);
  }
